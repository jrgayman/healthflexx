...
async function updateHealthcareRoles() {
  try {
    console.log('Updating healthcare roles schema...');
    ...
    console.log('Healthcare roles schema updated successfully!');
    return true;
  } catch (error) {
    console.error('Error updating healthcare roles schema:', error);
    return false;
  }
}

updateHealthcareRoles()
  .then(() => process.exit(0))
