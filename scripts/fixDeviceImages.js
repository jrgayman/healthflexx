...
async function fixDeviceImages() {
  try {
    console.log('Fixing device image storage...');
    ...
    console.log('Device image storage fixed successfully!');
    return true;
  } catch (error) {
    console.error('Error fixing device image storage:', error);
    return false;
  }
}
