...
async function removePatientTables() {
  try {
    console.log('Removing patient tables and consolidating schema...');
    ...
    const { error } = await supabase.rpc('exec_sql', {
      sql: `
        ...
        -- Add patient-related columns to users table
        ALTER TABLE users
        ADD COLUMN IF NOT EXISTS is_patient BOOLEAN DEFAULT true,
        ...
        -- Create function to handle patient creation
