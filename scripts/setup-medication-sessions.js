...
async function setupMedicationSessions() {
  try {
    console.log('Setting up medication sessions...');
    ...
    console.log('Medication sessions setup completed successfully!');
    return true;
  } catch (error) {
    console.error('Error setting up medication sessions:', error);
    return false;
  }
}

setupMedicationSessions()
  .then(() => process.exit(0))
