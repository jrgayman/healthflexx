...
INSERT INTO reading_types (
  ...
  ('Blood Pressure', 'BP', 'mmHg', 'blood_pressure', NULL, NULL, NULL, NULL, 'Blood pressure reading (systolic/diastolic)', '🫀'),
  ...
  ('Blood Glucose', 'BG', 'mmol/L', 'numeric', 4, 7, 3, 10, 'Blood glucose level', '🩸'),
...
CREATE TABLE medical_readings (
  ...
  UNIQUE(user_id, reading_type_id, reading_date)
);
