...
export default function StartSessionModal({ isOpen, onClose, patientId, onSessionStarted }) {
  ...
  const [timeSlots, setTimeSlots] = useState([
    { id: 1, label: 'Morning', defaultTime: '08:00', time: '08:00', enabled: true },
    { id: 2, label: 'Noon', defaultTime: '12:00', time: '12:00', enabled: true },
    { id: 3, label: 'Afternoon', defaultTime: '16:00', time: '16:00', enabled: true },
    { id: 4, label: 'Evening', defaultTime: '20:00', time: '20:00', enabled: true }
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create session with start date
                ...
                <div key={slot.id} className="space-y-2">
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      className="block rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary text-sm"
                    />
                  </div>
                </div>
              ))}
